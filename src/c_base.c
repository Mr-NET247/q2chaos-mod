...
void GetSettings()
{
	...
	//NET247 Bot Settings
	bot_chat = gi.cvar("bot_chat", "1", CVAR_SERVERINFO);
	bot_minbots = gi.cvar("bot_minbots", "2", CVAR_LATCH);
	bot_maxbots = gi.cvar("bot_maxbots", "8", CVAR_LATCH);
	bot_minskill = gi.cvar("bot_minskill", "0", CVAR_LATCH);
	bot_maxskill = gi.cvar("bot_maxskill", "4", CVAR_LATCH);
	bot_randskill = gi.cvar("bot_randskill", "0", CVAR_LATCH);
	bot_ratio = gi.cvar("bot_ratio", "1", CVAR_LATCH);
	bot_teamratio = gi.cvar("bot_teamratio", "50", CVAR_LATCH);
	bot_teamauto = gi.cvar("bot_teamauto", "0", CVAR_LATCH);
	bot_joindelay = gi.cvar("bot_joindelay", "0", CVAR_LATCH);
